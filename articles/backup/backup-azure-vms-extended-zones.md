...
For details on VM backup job progress phases and how to interpret the progress bar, see [VM backup job progress phases](backup-azure-arm-vms-prepare.md#vm-backup-job-progress-phases).
